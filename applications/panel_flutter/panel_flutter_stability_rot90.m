...
% Rotate 90 deg
structural_node_locs = [structural_node_locs_temp(:,2), structural_node_locs_temp(:,1), structural_node_locs_temp(:,3)];
...
% Rotate 90 deg
def_shape_function_mode1 = [def_shape_function_mode1_temp(:,2), def_shape_function_mode1_temp(:,1), def_shape_function_mode1_temp(:,3)];
...
% Rotate 90 deg
def_shape_function_mode2 = [def_shape_function_mode2_temp(:,2), def_shape_function_mode2_temp(:,1), def_shape_function_mode2_temp(:,3)];
