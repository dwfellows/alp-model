...
psi3_anal = @(x,y) abar.*(cosh(en.*x./L) - cos(en.*x./L) - an.*(sinh(en.*x./L)-sin(en.*x./L))) ...
                  .*(cosh(en.*y./L) - cos(en.*y./L) - an.*(sinh(en.*y./L)-sin(en.*y./L)));
...
dwdx = @(x,y) abar .* ( ( (en/L).*sinh(en.*x./L) + (en/L).*sin(en.*x./L) - an.*( (en/L).*cosh(en.*x./L)- (en/L).*cos(en.*x./L))) ...
                  .*(cosh(en.*y./L) - cos(en.*y./L) - an.*(sinh(en.*y./L)-sin(en.*y./L))) );
dwdy = @(x,y) abar .* ( (cosh(en.*x./L) - cos(en.*x./L) - an.*(sinh(en.*x./L)-sin(en.*x./L))) ...
                  .*( (en/L).*sinh(en.*y./L) + (en/L).*sin(en.*y./L) - an.*( (en/L).*cosh(en.*y./L)- (en/L).*cos(en.*y./L))) );
...
%dF1dq_anal = (-1/(L^1)) * integral2(fun, 0, L, 0, L);
%pause;
...
for l = 1:8
  if (l==1)
    elem_node = importdata('../fem_data/rect_plate_mesh/rect_c1/elements.txt'); elem_node = elem_node.data;
    node_elem = dlmread('../fem_data/rect_plate_mesh/rect_c1/node_elem.txt');
    nodes = dlmread('../fem_data/rect_plate_mesh/rect_c1/nodes.txt');
    structural_node_locs = nodes(:,2:4);
    xdir_deform = dlmread('../fem_data/rect_plate_mesh/rect_c1/xdir_deform.txt');
    ydir_deform = dlmread('../fem_data/rect_plate_mesh/rect_c1/ydir_deform.txt');
    zdir_deform = dlmread('../fem_data/rect_plate_mesh/rect_c1/zdir_deform.txt');
    surface_node_data = dlmread('../fem_data/rect_plate_mesh/rect_c1/face_nodes.txt');
    struct_faces = dlmread('../fem_data/rect_plate_mesh/rect_c1/surf_faces.txt');
  elseif (l==2)
    elem_node = importdata('../fem_data/rect_plate_mesh/rect_c2/elements.txt'); elem_node = elem_node.data;
    node_elem = dlmread('../fem_data/rect_plate_mesh/rect_c2/node_elem.txt');
    nodes = dlmread('../fem_data/rect_plate_mesh/rect_c2/nodes.txt');
    structural_node_locs = nodes(:,2:4);
    xdir_deform = dlmread('../fem_data/rect_plate_mesh/rect_c2/xdir_deform.txt');
    ydir_deform = dlmread('../fem_data/rect_plate_mesh/rect_c2/ydir_deform.txt');
    zdir_deform = dlmread('../fem_data/rect_plate_mesh/rect_c2/zdir_deform.txt');
    surface_node_data = dlmread('../fem_data/rect_plate_mesh/rect_c2/face_nodes.txt');
    struct_faces = dlmread('../fem_data/rect_plate_mesh/rect_c2/surf_faces.txt');
  elseif (l==3)
    elem_node = importdata('../fem_data/rect_plate_mesh/rect_c3/elements.txt'); elem_node = elem_node.data;
    node_elem = dlmread('../fem_data/rect_plate_mesh/rect_c3/node_elem.txt');
    nodes = dlmread('../fem_data/rect_plate_mesh/rect_c3/nodes.txt');
    structural_node_locs = nodes(:,2:4);
    xdir_deform = dlmread('../fem_data/rect_plate_mesh/rect_c3/xdir_deform.txt');
    ydir_deform = dlmread('../fem_data/rect_plate_mesh/rect_c3/ydir_deform.txt');
    zdir_deform = dlmread('../fem_data/rect_plate_mesh/rect_c3/zdir_deform.txt');
    surface_node_data = dlmread('../fem_data/rect_plate_mesh/rect_c3/face_nodes.txt');
    struct_faces = dlmread('../fem_data/rect_plate_mesh/rect_c3/surf_faces.txt');
  elseif (l==4)
    elem_node = importdata('../fem_data/rect_plate_mesh/rect_c4/elements.txt'); elem_node = elem_node.data;
    node_elem = dlmread('../fem_data/rect_plate_mesh/rect_c4/node_elem.txt');
    nodes = dlmread('../fem_data/rect_plate_mesh/rect_c4/nodes.txt');
    structural_node_locs = nodes(:,2:4);
    xdir_deform = dlmread('../fem_data/rect_plate_mesh/rect_c4/xdir_deform.txt');
    ydir_deform = dlmread('../fem_data/rect_plate_mesh/rect_c4/ydir_deform.txt');
    zdir_deform = dlmread('../fem_data/rect_plate_mesh/rect_c4/zdir_deform.txt');
    surface_node_data = dlmread('../fem_data/rect_plate_mesh/rect_c4/face_nodes.txt');
    struct_faces = dlmread('../fem_data/rect_plate_mesh/rect_c4/surf_faces.txt');
  elseif (l==5)
    elem_node = importdata('../fem_data/rect_plate_mesh/rect_c5/elements.txt'); elem_node = elem_node.data;
    node_elem = dlmread('../fem_data/rect_plate_mesh/rect_c5/node_elem.txt');
    nodes = dlmread('../fem_data/rect_plate_mesh/rect_c5/nodes.txt');
    structural_node_locs = nodes(:,2:4);
    xdir_deform = dlmread('../fem_data/rect_plate_mesh/rect_c5/xdir_deform.txt');
    ydir_deform = dlmread('../fem_data/rect_plate_mesh/rect_c5/ydir_deform.txt');
    zdir_deform = dlmread('../fem_data/rect_plate_mesh/rect_c5/zdir_deform.txt');
    surface_node_data = dlmread('../fem_data/rect_plate_mesh/rect_c5/face_nodes.txt');
    struct_faces = dlmread('../fem_data/rect_plate_mesh/rect_c5/surf_faces.txt');
  elseif (l==6)
    elem_node = importdata('../fem_data/rect_plate_mesh/rect_c6/elements.txt'); elem_node = elem_node.data;
    node_elem = dlmread('../fem_data/rect_plate_mesh/rect_c6/node_elem.txt');
    nodes = dlmread('../fem_data/rect_plate_mesh/rect_c6/nodes.txt');
    structural_node_locs = nodes(:,2:4);
    xdir_deform = dlmread('../fem_data/rect_plate_mesh/rect_c6/xdir_deform.txt');
    ydir_deform = dlmread('../fem_data/rect_plate_mesh/rect_c6/ydir_deform.txt');
    zdir_deform = dlmread('../fem_data/rect_plate_mesh/rect_c6/zdir_deform.txt');
    surface_node_data = dlmread('../fem_data/rect_plate_mesh/rect_c6/face_nodes.txt');
    struct_faces = dlmread('../fem_data/rect_plate_mesh/rect_c6/surf_faces.txt');
  elseif (l==7)
    elem_node = importdata('../fem_data/rect_plate_mesh/rect_c7/elements.txt'); elem_node = elem_node.data;
    node_elem = dlmread('../fem_data/rect_plate_mesh/rect_c7/node_elem.txt');
    nodes = dlmread('../fem_data/rect_plate_mesh/rect_c7/nodes.txt');
    structural_node_locs = nodes(:,2:4);
    xdir_deform = dlmread('../fem_data/rect_plate_mesh/rect_c7/xdir_deform.txt');
    ydir_deform = dlmread('../fem_data/rect_plate_mesh/rect_c7/ydir_deform.txt');
    zdir_deform = dlmread('../fem_data/rect_plate_mesh/rect_c7/zdir_deform.txt');
    surface_node_data = dlmread('../fem_data/rect_plate_mesh/rect_c7/face_nodes.txt');
    struct_faces = dlmread('../fem_data/rect_plate_mesh/rect_c7/surf_faces.txt');
  elseif (l==8)
    elem_node = importdata('../fem_data/rect_plate_mesh/rect_c8/elements.txt'); elem_node = elem_node.data;
    node_elem = dlmread('../fem_data/rect_plate_mesh/rect_c8/node_elem.txt');
    nodes = dlmread('../fem_data/rect_plate_mesh/rect_c8/nodes.txt');
    structural_node_locs = nodes(:,2:4);
    xdir_deform = dlmread('../fem_data/rect_plate_mesh/rect_c8/xdir_deform.txt');
    ydir_deform = dlmread('../fem_data/rect_plate_mesh/rect_c8/ydir_deform.txt');
    zdir_deform = dlmread('../fem_data/rect_plate_mesh/rect_c8/zdir_deform.txt');
    surface_node_data = dlmread('../fem_data/rect_plate_mesh/rect_c8/face_nodes.txt');
    struct_faces = dlmread('../fem_data/rect_plate_mesh/rect_c8/surf_faces.txt');
  end
...
grid on;
xlabel('$h / L$', 'interpreter', 'latex', 'fontsize', fs);
ylabel('$|| \frac{dF_1}{dq_1} |_{n} - \frac{dF_1}{dq_1} |_{n,f} || / || \frac{d\hat{n}}{dq_1} |_{n,f} ||$', 'interpreter', 'latex', 'fontsize', fs);
title('Self-Convergence of Numerical Approximation of Imposed $\frac{dF_{1}}{dq_{1}}$', 'interpreter', 'latex', 'fontsize', fs);
