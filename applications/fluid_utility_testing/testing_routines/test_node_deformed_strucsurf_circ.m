...
legend('Numerical', '$\mathcal{O} (h^2)$', 'interpreter', 'latex', 'location', 'northwest', 'fontsize', 18);
xlabel('$h$', 'interpreter', 'latex', 'fontsize', 18);
ylabel('$\max_{\Omega} \big( | \hat{n}_a - \hat{n}_n | \big)$', 'interpreter', 'latex', 'fontsize', 18);
title('$L_{\infty}$ Error of $\hat{n}$, Circular Plate, First Axisymmetric Mode (Analytical Data)', 'interpreter', 'latex', 'fontsize', 18);
