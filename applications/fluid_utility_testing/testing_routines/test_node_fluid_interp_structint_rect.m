...
en = 4.7300408;
an = 0.98250222;
psi3_anal_temp = @(x,y) (cosh(en.*x./L) - cos(en.*x./L) - an.*(sinh(en.*x./L)-sin(en.*x./L))) ...
                  .*(cosh(en.*y./L) - cos(en.*y./L) - an.*(sinh(en.*y./L)-sin(en.*y./L)));
abar = l1 ./ psi3_anal_temp(L/2,L/2);
psi3_anal_hyp = @(x,y) abar.*(cosh(en.*x./L) - cos(en.*x./L) - an.*(sinh(en.*x./L)-sin(en.*x./L))) ...
                  .*(cosh(en.*y./L) - cos(en.*y./L) - an.*(sinh(en.*y./L)-sin(en.*y./L)));


% Define analytical values
rhol = @(x,y) (-(y./L).*((y-L)./L)) .* (x./L).^1 + 1; % Works
...
% deformation_errs = zeros(2,5);
% for l = 1:5
%   if (l==1)
%     elem_node = importdata('../circular_data/new_circ_data/rect_plate/rect_c1/elements.txt'); elem_node = elem_node.data;
%     node_elem = dlmread('../circular_data/new_circ_data/rect_plate/rect_c1/node_elem.txt');
%     nodes = dlmread('../circular_data/new_circ_data/rect_plate/rect_c1/nodes.txt');
%     structural_node_locs = nodes(:,2:4);
%     xdir_deform = dlmread('../circular_data/new_circ_data/rect_plate/rect_c1/xdir_deform.txt');
%     ydir_deform = dlmread('../circular_data/new_circ_data/rect_plate/rect_c1/ydir_deform.txt');
%     zdir_deform = dlmread('../circular_data/new_circ_data/rect_plate/rect_c1/zdir_deform.txt');
%     surface_node_data = dlmread('../circular_data/new_circ_data/rect_plate/rect_c1/face_nodes.txt');
%     struct_faces = dlmread('../circular_data/new_circ_data/rect_plate/rect_c1/surf_faces.txt');
%   elseif (l==2)
%     elem_node = importdata('../circular_data/new_circ_data/rect_plate/rect_c2/elements.txt'); elem_node = elem_node.data;
%     node_elem = dlmread('../circular_data/new_circ_data/rect_plate/rect_c2/node_elem.txt');
%     nodes = dlmread('../circular_data/new_circ_data/rect_plate/rect_c2/nodes.txt');
%     structural_node_locs = nodes(:,2:4);
%     xdir_deform = dlmread('../circular_data/new_circ_data/rect_plate/rect_c2/xdir_deform.txt');
%     ydir_deform = dlmread('../circular_data/new_circ_data/rect_plate/rect_c2/ydir_deform.txt');
%     zdir_deform = dlmread('../circular_data/new_circ_data/rect_plate/rect_c2/zdir_deform.txt');
%     surface_node_data = dlmread('../circular_data/new_circ_data/rect_plate/rect_c2/face_nodes.txt');
%     struct_faces = dlmread('../circular_data/new_circ_data/rect_plate/rect_c2/surf_faces.txt');
%   elseif (l==3)
%     elem_node = importdata('../circular_data/new_circ_data/rect_plate/rect_c3/elements.txt'); elem_node = elem_node.data;
%     node_elem = dlmread('../circular_data/new_circ_data/rect_plate/rect_c3/node_elem.txt');
%     nodes = dlmread('../circular_data/new_circ_data/rect_plate/rect_c3/nodes.txt');
%     structural_node_locs = nodes(:,2:4);
%     xdir_deform = dlmread('../circular_data/new_circ_data/rect_plate/rect_c3/xdir_deform.txt');
%     ydir_deform = dlmread('../circular_data/new_circ_data/rect_plate/rect_c3/ydir_deform.txt');
%     zdir_deform = dlmread('../circular_data/new_circ_data/rect_plate/rect_c3/zdir_deform.txt');
%     surface_node_data = dlmread('../circular_data/new_circ_data/rect_plate/rect_c3/face_nodes.txt');
%     struct_faces = dlmread('../circular_data/new_circ_data/rect_plate/rect_c3/surf_faces.txt');
%   elseif (l==4)
%     elem_node = importdata('../circular_data/new_circ_data/rect_plate/rect_c4/elements.txt'); elem_node = elem_node.data;
%     node_elem = dlmread('../circular_data/new_circ_data/rect_plate/rect_c4/node_elem.txt');
%     nodes = dlmread('../circular_data/new_circ_data/rect_plate/rect_c4/nodes.txt');
%     structural_node_locs = nodes(:,2:4);
%     xdir_deform = dlmread('../circular_data/new_circ_data/rect_plate/rect_c4/xdir_deform.txt');
%     ydir_deform = dlmread('../circular_data/new_circ_data/rect_plate/rect_c4/ydir_deform.txt');
%     zdir_deform = dlmread('../circular_data/new_circ_data/rect_plate/rect_c4/zdir_deform.txt');
%     surface_node_data = dlmread('../circular_data/new_circ_data/rect_plate/rect_c4/face_nodes.txt');
%     struct_faces = dlmread('../circular_data/new_circ_data/rect_plate/rect_c4/surf_faces.txt');
%   elseif (l==5)
%     elem_node = importdata('../circular_data/new_circ_data/rect_plate/rect_c5/elements.txt'); elem_node = elem_node.data;
%     node_elem = dlmread('../circular_data/new_circ_data/rect_plate/rect_c5/node_elem.txt');
%     nodes = dlmread('../circular_data/new_circ_data/rect_plate/rect_c5/nodes.txt');
%     structural_node_locs = nodes(:,2:4);
%     xdir_deform = dlmread('../circular_data/new_circ_data/rect_plate/rect_c5/xdir_deform.txt');
%     ydir_deform = dlmread('../circular_data/new_circ_data/rect_plate/rect_c5/ydir_deform.txt');
%     zdir_deform = dlmread('../circular_data/new_circ_data/rect_plate/rect_c5/zdir_deform.txt');
%     surface_node_data = dlmread('../circular_data/new_circ_data/rect_plate/rect_c5/face_nodes.txt');
%     struct_faces = dlmread('../circular_data/new_circ_data/rect_plate/rect_c5/surf_faces.txt');
%   end
%   
...
% 
% diffs = abs(deformation_errs(1,1:end-1) - deformation_errs(1,end))
...
% legend('Numerical', '$\mathcal{O}(h^2)$', 'interpreter', 'latex', 'fontsize', 18);
% xlabel('$h/L$', 'interpreter', 'latex', 'fontsize', fs); 
% ylabel('$\Big( \max_{\Omega} \psi_3 - w_{3} \Big)_{n} - \Big( \max_{\Omega} \psi_3 - w_{3} \Big)_{n,f}$', 'interpreter', 'latex', 'fontsize', fs);
% title('Error of FEM Solution $L_{\infty}$ Error to Thin Plate Approx.', 'interpreter', 'latex', 'fontsize', fs);
% pause;
...
for l = 1:5
  if (l==1)
    elem_node = importdata('../fem_data/new_circ_data/rect_plate/rect_c1/elements.txt'); elem_node = elem_node.data;
    node_elem = dlmread('../fem_data/new_circ_data/rect_plate/rect_c1/node_elem.txt');
    nodes = dlmread('../fem_data/new_circ_data/rect_plate/rect_c1/nodes.txt');
    structural_node_locs = nodes(:,2:4);
    xdir_deform = dlmread('../fem_data/new_circ_data/rect_plate/rect_c1/xdir_deform.txt');
    ydir_deform = dlmread('../fem_data/new_circ_data/rect_plate/rect_c1/ydir_deform.txt');
    zdir_deform = dlmread('../fem_data/new_circ_data/rect_plate/rect_c1/zdir_deform.txt');
    surface_node_data = dlmread('../fem_data/new_circ_data/rect_plate/rect_c1/face_nodes.txt');
    struct_faces = dlmread('../fem_data/new_circ_data/rect_plate/rect_c1/surf_faces.txt');
  elseif (l==2)
    elem_node = importdata('../fem_data/new_circ_data/rect_plate/rect_c2/elements.txt'); elem_node = elem_node.data;
    node_elem = dlmread('../fem_data/new_circ_data/rect_plate/rect_c2/node_elem.txt');
    nodes = dlmread('../fem_data/new_circ_data/rect_plate/rect_c2/nodes.txt');
    structural_node_locs = nodes(:,2:4);
    xdir_deform = dlmread('../fem_data/new_circ_data/rect_plate/rect_c2/xdir_deform.txt');
    ydir_deform = dlmread('../fem_data/new_circ_data/rect_plate/rect_c2/ydir_deform.txt');
    zdir_deform = dlmread('../fem_data/new_circ_data/rect_plate/rect_c2/zdir_deform.txt');
    surface_node_data = dlmread('../fem_data/new_circ_data/rect_plate/rect_c2/face_nodes.txt');
    struct_faces = dlmread('../fem_data/new_circ_data/rect_plate/rect_c2/surf_faces.txt');
  elseif (l==3)
    elem_node = importdata('../fem_data/new_circ_data/rect_plate/rect_c3/elements.txt'); elem_node = elem_node.data;
    node_elem = dlmread('../fem_data/new_circ_data/rect_plate/rect_c3/node_elem.txt');
    nodes = dlmread('../fem_data/new_circ_data/rect_plate/rect_c3/nodes.txt');
    structural_node_locs = nodes(:,2:4);
    xdir_deform = dlmread('../fem_data/new_circ_data/rect_plate/rect_c3/xdir_deform.txt');
    ydir_deform = dlmread('../fem_data/new_circ_data/rect_plate/rect_c3/ydir_deform.txt');
    zdir_deform = dlmread('../fem_data/new_circ_data/rect_plate/rect_c3/zdir_deform.txt');
    surface_node_data = dlmread('../fem_data/new_circ_data/rect_plate/rect_c3/face_nodes.txt');
    struct_faces = dlmread('../fem_data/new_circ_data/rect_plate/rect_c3/surf_faces.txt');
  elseif (l==4)
    elem_node = importdata('../fem_data/new_circ_data/rect_plate/rect_c4/elements.txt'); elem_node = elem_node.data;
    node_elem = dlmread('../fem_data/new_circ_data/rect_plate/rect_c4/node_elem.txt');
    nodes = dlmread('../fem_data/new_circ_data/rect_plate/rect_c4/nodes.txt');
    structural_node_locs = nodes(:,2:4);
    xdir_deform = dlmread('../fem_data/new_circ_data/rect_plate/rect_c4/xdir_deform.txt');
    ydir_deform = dlmread('../fem_data/new_circ_data/rect_plate/rect_c4/ydir_deform.txt');
    zdir_deform = dlmread('../fem_data/new_circ_data/rect_plate/rect_c4/zdir_deform.txt');
    surface_node_data = dlmread('../fem_data/new_circ_data/rect_plate/rect_c4/face_nodes.txt');
    struct_faces = dlmread('../fem_data/new_circ_data/rect_plate/rect_c4/surf_faces.txt');
  elseif (l==5)
    elem_node = importdata('../fem_data/new_circ_data/rect_plate/rect_c5/elements.txt'); elem_node = elem_node.data;
    node_elem = dlmread('../fem_data/new_circ_data/rect_plate/rect_c5/node_elem.txt');
    nodes = dlmread('../fem_data/new_circ_data/rect_plate/rect_c5/nodes.txt');
    structural_node_locs = nodes(:,2:4);
    xdir_deform = dlmread('../fem_data/new_circ_data/rect_plate/rect_c5/xdir_deform.txt');
    ydir_deform = dlmread('../fem_data/new_circ_data/rect_plate/rect_c5/ydir_deform.txt');
    zdir_deform = dlmread('../fem_data/new_circ_data/rect_plate/rect_c5/zdir_deform.txt');
    surface_node_data = dlmread('../fem_data/new_circ_data/rect_plate/rect_c5/face_nodes.txt');
    struct_faces = dlmread('../fem_data/new_circ_data/rect_plate/rect_c5/surf_faces.txt');
  end
...
%    def_shape_function(j,:) = [0 0 psi3_anal(x,y)];
%  end
...
%    v3 = [vu3; vv3; vw3];
    ...
    % Integrate psi over plate
    psi_int1 = psi1(3)*A1;
    psi_int2 = psi2(3)*A2;
    psi_int3 = psi3(3)*A3;
    psi_int_loc = quadrature(psi_int1, psi_int2, psi_int3);
    psi_int = psi_int + psi_int_loc;

  end

  dF1dq_approx = [dF1dq_approx, dF1dq];
  psi_int_approx = [psi_int_approx, psi_int];
...
% Compute psi integrals analytically
psi_anal = integral2(psi3_anal, 0, L, 0, L);
psi_hyp_anal = integral2(psi3_anal_hyp, 0, L, 0, L);
...
%xlim([7.5e-3, 1e-1]); ylim([1e-5, 1e0]);
a = get(gca,'YTickLabel');
set(gca,'YTickLabel',a,'fontsize',18);
grid on;
xlabel('$h / L$', 'interpreter', 'latex', 'fontsize', fs);
ylabel('Error: $|| I_n - I_a || / || I_a ||$', 'interpreter', 'latex', 'fontsize', fs);
...
% Try the non-dimensional approx
diffs = abs((dF1dq_approx./L) - (dF1dq_anal./L)) ./ abs(dF1dq_anal./L);
c2 = diffs(end) / elem_h_list(end)^2;
yc2 = c2.*elem_h_list.^2;
...
grid on;
xlabel('$h / L$', 'interpreter', 'latex', 'fontsize', fs);
ylabel('$\frac{dF_{1}}{dq_{1}} |_{n} / L - \frac{dF_{1}}{dq_{1}} |_{a} / L$', 'interpreter', 'latex', 'fontsize', fs);
title('Non-Dimensional Error', 'interpreter', 'latex', 'fontsize', fs);
