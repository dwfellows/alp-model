...
%rhol = @(x,y) (x.^0).*y.^1 + 1;
%rhol = @(x,y) (y.^0).*(x.^1) + 1;
%al = @(x,y) 123.*sqrt(1.4*287*300) .* ( x.^0 ) .* (y.^0);
al = @(x,y) 300.*(x.^0).*(y.^0);
...
%  for l = 1:7
%    if (l==1)
%      elem_node = importdata('../circular_data/rect_plate_thinner/rect_c1/elements.txt'); elem_node = elem_node.data;
%      node_elem = dlmread('../circular_data/rect_plate_thinner/rect_c1/node_elem.txt');
%      nodes = dlmread('../circular_data/rect_plate_thinner/rect_c1/nodes.txt');
%      structural_node_locs = nodes(:,2:4);
%      xdir_deform = dlmread('../circular_data/rect_plate_thinner/rect_c1/xdir_deform.txt');
%      ydir_deform = dlmread('../circular_data/rect_plate_thinner/rect_c1/ydir_deform.txt');
%      zdir_deform = dlmread('../circular_data/rect_plate_thinner/rect_c1/zdir_deform.txt');
%      surface_node_data = dlmread('../circular_data/rect_plate_thinner/rect_c1/face_nodes.txt');
%      struct_faces = dlmread('../circular_data/rect_plate_thinner/rect_c1/surf_faces.txt');
%    elseif (l==2)
%      elem_node = importdata('../circular_data/rect_plate_thinner/rect_c2/elements.txt'); elem_node = elem_node.data;
%      node_elem = dlmread('../circular_data/rect_plate_thinner/rect_c2/node_elem.txt');
%      nodes = dlmread('../circular_data/rect_plate_thinner/rect_c2/nodes.txt');
%      structural_node_locs = nodes(:,2:4);
%      xdir_deform = dlmread('../circular_data/rect_plate_thinner/rect_c2/xdir_deform.txt');
%      ydir_deform = dlmread('../circular_data/rect_plate_thinner/rect_c2/ydir_deform.txt');
%      zdir_deform = dlmread('../circular_data/rect_plate_thinner/rect_c2/zdir_deform.txt');
%      surface_node_data = dlmread('../circular_data/rect_plate_thinner/rect_c2/face_nodes.txt');
%      struct_faces = dlmread('../circular_data/rect_plate_thinner/rect_c2/surf_faces.txt');
%    elseif (l==3)
%      elem_node = importdata('../circular_data/rect_plate_thinner/rect_c3/elements.txt'); elem_node = elem_node.data;
%      node_elem = dlmread('../circular_data/rect_plate_thinner/rect_c3/node_elem.txt');
%      nodes = dlmread('../circular_data/rect_plate_thinner/rect_c3/nodes.txt');
%      structural_node_locs = nodes(:,2:4);
%      xdir_deform = dlmread('../circular_data/rect_plate_thinner/rect_c3/xdir_deform.txt');
%      ydir_deform = dlmread('../circular_data/rect_plate_thinner/rect_c3/ydir_deform.txt');
%      zdir_deform = dlmread('../circular_data/rect_plate_thinner/rect_c3/zdir_deform.txt');
%      surface_node_data = dlmread('../circular_data/rect_plate_thinner/rect_c3/face_nodes.txt');
%      struct_faces = dlmread('../circular_data/rect_plate_thinner/rect_c3/surf_faces.txt');
%    elseif (l==4)
%      elem_node = importdata('../circular_data/rect_plate_thinner/rect_c4/elements.txt'); elem_node = elem_node.data;
%      node_elem = dlmread('../circular_data/rect_plate_thinner/rect_c4/node_elem.txt');
%      nodes = dlmread('../circular_data/rect_plate_thinner/rect_c4/nodes.txt');
%      structural_node_locs = nodes(:,2:4);
%      xdir_deform = dlmread('../circular_data/rect_plate_thinner/rect_c4/xdir_deform.txt');
%      ydir_deform = dlmread('../circular_data/rect_plate_thinner/rect_c4/ydir_deform.txt');
%      zdir_deform = dlmread('../circular_data/rect_plate_thinner/rect_c4/zdir_deform.txt');
%      surface_node_data = dlmread('../circular_data/rect_plate_thinner/rect_c4/face_nodes.txt');
%      struct_faces = dlmread('../circular_data/rect_plate_thinner/rect_c4/surf_faces.txt');
%    elseif (l==5)
%      elem_node = importdata('../circular_data/rect_plate_thinner/rect_c5/elements.txt'); elem_node = elem_node.data;
%      node_elem = dlmread('../circular_data/rect_plate_thinner/rect_c5/node_elem.txt');
%      nodes = dlmread('../circular_data/rect_plate_thinner/rect_c5/nodes.txt');
%      structural_node_locs = nodes(:,2:4);
%      xdir_deform = dlmread('../circular_data/rect_plate_thinner/rect_c5/xdir_deform.txt');
%      ydir_deform = dlmread('../circular_data/rect_plate_thinner/rect_c5/ydir_deform.txt');
%      zdir_deform = dlmread('../circular_data/rect_plate_thinner/rect_c5/zdir_deform.txt');
%      surface_node_data = dlmread('../circular_data/rect_plate_thinner/rect_c5/face_nodes.txt');
%      struct_faces = dlmread('../circular_data/rect_plate_thinner/rect_c5/surf_faces.txt');
%    elseif (l==6)
%      elem_node = importdata('../circular_data/rect_plate_thinner/rect_c6/elements.txt'); elem_node = elem_node.data;
%      node_elem = dlmread('../circular_data/rect_plate_thinner/rect_c6/node_elem.txt');
%      nodes = dlmread('../circular_data/rect_plate_thinner/rect_c6/nodes.txt');
%      structural_node_locs = nodes(:,2:4);
%      xdir_deform = dlmread('../circular_data/rect_plate_thinner/rect_c6/xdir_deform.txt');
%      ydir_deform = dlmread('../circular_data/rect_plate_thinner/rect_c6/ydir_deform.txt');
%      zdir_deform = dlmread('../circular_data/rect_plate_thinner/rect_c6/zdir_deform.txt');
%      surface_node_data = dlmread('../circular_data/rect_plate_thinner/rect_c6/face_nodes.txt');
%      struct_faces = dlmread('../circular_data/rect_plate_thinner/rect_c6/surf_faces.txt');
%    elseif (l==7)
%      elem_node = importdata('../circular_data/rect_plate_thinner/rect_c7/elements.txt'); elem_node = elem_node.data;
%      node_elem = dlmread('../circular_data/rect_plate_thinner/rect_c7/node_elem.txt');
%      nodes = dlmread('../circular_data/rect_plate_thinner/rect_c7/nodes.txt');
%      structural_node_locs = nodes(:,2:4);
%      xdir_deform = dlmread('../circular_data/rect_plate_thinner/rect_c7/xdir_deform.txt');
%      ydir_deform = dlmread('../circular_data/rect_plate_thinner/rect_c7/ydir_deform.txt');
%      zdir_deform = dlmread('../circular_data/rect_plate_thinner/rect_c7/zdir_deform.txt');
%      surface_node_data = dlmread('../circular_data/rect_plate_thinner/rect_c7/face_nodes.txt');
%      struct_faces = dlmread('../circular_data/rect_plate_thinner/rect_c7/surf_faces.txt');
%    end
%  
...
for l = 1:7
  if (l==1)
    elem_node = importdata('../fem_data/rect_plate_thinner/rect_c1/elements.txt'); elem_node = elem_node.data;
    node_elem = dlmread('../fem_data/rect_plate_thinner/rect_c1/node_elem.txt');
    nodes = dlmread('../fem_data/rect_plate_thinner/rect_c1/nodes.txt');
    structural_node_locs = nodes(:,2:4);
    xdir_deform = dlmread('../fem_data/rect_plate_thinner/rect_c1/xdir_deform.txt');
    ydir_deform = dlmread('../fem_data/rect_plate_thinner/rect_c1/ydir_deform.txt');
    zdir_deform = dlmread('../fem_data/rect_plate_thinner/rect_c1/zdir_deform.txt');
    surface_node_data = dlmread('../fem_data/rect_plate_thinner/rect_c1/face_nodes.txt');
    struct_faces = dlmread('../fem_data/rect_plate_thinner/rect_c1/surf_faces.txt');
  elseif (l==2)
    elem_node = importdata('../fem_data/rect_plate_thinner/rect_c2/elements.txt'); elem_node = elem_node.data;
    node_elem = dlmread('../fem_data/rect_plate_thinner/rect_c2/node_elem.txt');
    nodes = dlmread('../fem_data/rect_plate_thinner/rect_c2/nodes.txt');
    structural_node_locs = nodes(:,2:4);
    xdir_deform = dlmread('../fem_data/rect_plate_thinner/rect_c2/xdir_deform.txt');
    ydir_deform = dlmread('../fem_data/rect_plate_thinner/rect_c2/ydir_deform.txt');
    zdir_deform = dlmread('../fem_data/rect_plate_thinner/rect_c2/zdir_deform.txt');
    surface_node_data = dlmread('../fem_data/rect_plate_thinner/rect_c2/face_nodes.txt');
    struct_faces = dlmread('../fem_data/rect_plate_thinner/rect_c2/surf_faces.txt');
  elseif (l==3)
    elem_node = importdata('../fem_data/rect_plate_thinner/rect_c3/elements.txt'); elem_node = elem_node.data;
    node_elem = dlmread('../fem_data/rect_plate_thinner/rect_c3/node_elem.txt');
    nodes = dlmread('../fem_data/rect_plate_thinner/rect_c3/nodes.txt');
    structural_node_locs = nodes(:,2:4);
    xdir_deform = dlmread('../fem_data/rect_plate_thinner/rect_c3/xdir_deform.txt');
    ydir_deform = dlmread('../fem_data/rect_plate_thinner/rect_c3/ydir_deform.txt');
    zdir_deform = dlmread('../fem_data/rect_plate_thinner/rect_c3/zdir_deform.txt');
    surface_node_data = dlmread('../fem_data/rect_plate_thinner/rect_c3/face_nodes.txt');
    struct_faces = dlmread('../fem_data/rect_plate_thinner/rect_c3/surf_faces.txt');
  elseif (l==4)
    elem_node = importdata('../fem_data/rect_plate_thinner/rect_c4/elements.txt'); elem_node = elem_node.data;
    node_elem = dlmread('../fem_data/rect_plate_thinner/rect_c4/node_elem.txt');
    nodes = dlmread('../fem_data/rect_plate_thinner/rect_c4/nodes.txt');
    structural_node_locs = nodes(:,2:4);
    xdir_deform = dlmread('../fem_data/rect_plate_thinner/rect_c4/xdir_deform.txt');
    ydir_deform = dlmread('../fem_data/rect_plate_thinner/rect_c4/ydir_deform.txt');
    zdir_deform = dlmread('../fem_data/rect_plate_thinner/rect_c4/zdir_deform.txt');
    surface_node_data = dlmread('../fem_data/rect_plate_thinner/rect_c4/face_nodes.txt');
    struct_faces = dlmread('../fem_data/rect_plate_thinner/rect_c4/surf_faces.txt');
  elseif (l==5)
    elem_node = importdata('../fem_data/rect_plate_thinner/rect_c5/elements.txt'); elem_node = elem_node.data;
    node_elem = dlmread('../fem_data/rect_plate_thinner/rect_c5/node_elem.txt');
    nodes = dlmread('../fem_data/rect_plate_thinner/rect_c5/nodes.txt');
    structural_node_locs = nodes(:,2:4);
    xdir_deform = dlmread('../fem_data/rect_plate_thinner/rect_c5/xdir_deform.txt');
    ydir_deform = dlmread('../fem_data/rect_plate_thinner/rect_c5/ydir_deform.txt');
    zdir_deform = dlmread('../fem_data/rect_plate_thinner/rect_c5/zdir_deform.txt');
    surface_node_data = dlmread('../fem_data/rect_plate_thinner/rect_c5/face_nodes.txt');
    struct_faces = dlmread('../fem_data/rect_plate_thinner/rect_c5/surf_faces.txt');
  elseif (l==6)
    elem_node = importdata('../fem_data/rect_plate_thinner/rect_c6/elements.txt'); elem_node = elem_node.data;
    node_elem = dlmread('../fem_data/rect_plate_thinner/rect_c6/node_elem.txt');
    nodes = dlmread('../fem_data/rect_plate_thinner/rect_c6/nodes.txt');
    structural_node_locs = nodes(:,2:4);
    xdir_deform = dlmread('../fem_data/rect_plate_thinner/rect_c6/xdir_deform.txt');
    ydir_deform = dlmread('../fem_data/rect_plate_thinner/rect_c6/ydir_deform.txt');
    zdir_deform = dlmread('../fem_data/rect_plate_thinner/rect_c6/zdir_deform.txt');
    surface_node_data = dlmread('../fem_data/rect_plate_thinner/rect_c6/face_nodes.txt');
    struct_faces = dlmread('../fem_data/rect_plate_thinner/rect_c6/surf_faces.txt');
  elseif (l==7)
    elem_node = importdata('../fem_data/rect_plate_thinner/rect_c7/elements.txt'); elem_node = elem_node.data;
    node_elem = dlmread('../fem_data/rect_plate_thinner/rect_c7/node_elem.txt');
    nodes = dlmread('../fem_data/rect_plate_thinner/rect_c7/nodes.txt');
    structural_node_locs = nodes(:,2:4);
    xdir_deform = dlmread('../fem_data/rect_plate_thinner/rect_c7/xdir_deform.txt');
    ydir_deform = dlmread('../fem_data/rect_plate_thinner/rect_c7/ydir_deform.txt');
    zdir_deform = dlmread('../fem_data/rect_plate_thinner/rect_c7/zdir_deform.txt');
    surface_node_data = dlmread('../fem_data/rect_plate_thinner/rect_c7/face_nodes.txt');
    struct_faces = dlmread('../fem_data/rect_plate_thinner/rect_c7/surf_faces.txt');
  end
