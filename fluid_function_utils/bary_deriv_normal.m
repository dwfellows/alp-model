function [normal] = bary_deriv_normal(struc_elem_locs, fluid_node_loc, fluid_node_loc_barycentric, bary_coord_num)
  ...
  if (bary_coord_num == 1)
    ...
    dx_dL4 = struc_elem_locs(2,:).*(-3 + 4*fluid_node_loc_barycentric(3) + 4*fluid_node_loc_barycentric(4)) ...
           ...
           + 4.*struc_elem_locs(9,:).*(1 - fluid_node_loc_barycentric(3) - 2*fluid_node_loc_barycentric(4)) + 4.*struc_elem_locs(10,:).*fluid_node_loc_barycentric(3);
...
%    dx_dL2 = struc_elem_locs(1,:).*(-3 + 4*fluid_node_loc_barycentric(3) + 4*fluid_node_loc_barycentric(4)) ...
%           - struc_elem_locs(2,:) + 4.*struc_elem_locs(5,:).*(1-fluid_node_loc_barycentric(3) - fluid_node_loc_barycentric(4)) ...
...
%           + 4.*struc_elem_locs(8,:).*(-fluid_node_loc_barycentric(4)) + 4.*struc_elem_locs(9,:).*fluid_node_loc_barycentric(4);
    ...
    dx_dL3 = struc_elem_locs(1,:).*(-3 + 4*fluid_node_loc_barycentric(3) + 4*fluid_node_loc_barycentric(4)) ...
           + struc_elem_locs(3,:).*(4*fluid_node_loc_barycentric(3) - 1) ...
           + 4.*struc_elem_locs(7,:).*(1-2*fluid_node_loc_barycentric(3) - fluid_node_loc_barycentric(4)) ...
           + 4.*struc_elem_locs(8,:).*(-fluid_node_loc_barycentric(4)) ...
