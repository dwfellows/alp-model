function [kI] = kinetic_energy_diag(elem_nodes, node_loc, psi_i, mat_props)
  ...
  for i = 1:nelm
    ...
    psi_i_dot_nodes = dot(psi_i_nodes, psi_i_nodes, 2);
  
    % Interpolate displacement values at quadrature points
    psi1_sq = shape_interpolation([alpha,beta,beta,beta], psi_i_dot_nodes);
    psi2_sq = shape_interpolation([beta,alpha,beta,beta], psi_i_dot_nodes);
    psi3_sq = shape_interpolation([beta,beta,alpha,beta], psi_i_dot_nodes);
    psi4_sq = shape_interpolation([beta,beta,beta,alpha], psi_i_dot_nodes);
